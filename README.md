...
### OUTPUT:
![image](https://github.com/user-attachments/assets/748e4cdf-817f-470a-9cff-021408719e83)


### RESULT:
Hence to design and implement a LangChain Expression Language (LCEL) expression that utilizes at least two prompt parameters and three key components (prompt, model, and output parser), and to evaluate its functionality by analyzing relevant examples of its application in real-world scenarios.
